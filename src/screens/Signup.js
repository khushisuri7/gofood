      ...
      <Navbar />
        ...
        <div className='container' >
          <form className='w-50 m-auto mt-5 border bg-light border-success rounded' onSubmit={handleSubmit}>
            <div className="m-3">
              <label htmlFor="name" className="form-label" placeholder='enter name'>Name</label>
              <input type="text" className="form-control" name='name' value={credentials.name} onChange={onChange} aria-describedby="emailHelp" />
            </div>
            <div className="m-3">
              <label htmlFor="email" className="form-label" placeholder='enter email'>Email address</label>
              <input type="email" className="form-control" name='email' value={credentials.email} onChange={onChange} aria-describedby="emailHelp" />
            </div>
            <div className="m-3">
              <label htmlFor="address" className="form-label" placeholder='enter address'>Address</label>
              <fieldset>
            ...
            <div className="m-3">
              <label htmlFor="exampleInputPassword1" className="form-label" placeholder='enter password'>Password</label>
